...
public class HttpSender {
	 ...
	 private static final  	String un = "N2880155";// 账号
	 private static final  	String pw = "FP8ti7qA0M63ba";// 密码
	...
	public static String batchSend(String phone, String msg) throws Exception {
		if(StringUtil.isEmpty(phone)||StringUtil.isEmpty(msg)){
			return null;
		}
	...
	public static void main(String[] args) {
		try {
			String reult=batchSend("13671707490", "【脑立方】您好，您的验证码是:123456");
