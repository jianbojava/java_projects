package com.cocosh.framework.zxing;
...
public class QRCode {
    ...
    // 二维码尺寸  
    private static final int QRCODE_SIZE = 1418;  
    // LOGO宽度  
    ...
    public static void encode_simple(String text,String destPath) throws Exception{
    	Hashtable<EncodeHintType, String> hints = new Hashtable<EncodeHintType, String>();
		hints.put(EncodeHintType.CHARACTER_SET, CHARSET);   // 内容所使用字符集编码
    ...
    public static void encode_simple(String text,OutputStream os) throws Exception{
    	Hashtable<EncodeHintType, String> hints = new Hashtable<EncodeHintType, String>();
		hints.put(EncodeHintType.CHARACTER_SET, CHARSET);   // 内容所使用字符集编码
		BitMatrix bitMatrix = new MultiFormatWriter().encode(text, BarcodeFormat.QR_CODE, QRCODE_SIZE, QRCODE_SIZE, hints);
		// 生成二维码
		MatrixToImageWriter.writeToStream(bitMatrix, FORMAT_NAME, os);
    }
  
    public static void main(String[] args) throws Exception {
    	//生成二维码 带logo
        String text = "http://mall.youngor.com/wap";  
        QRCode.encode(text, "D:\\1.jpg", "d:\\2.jpg", true);
        //生成简单二维码
        QRCode.encode_simple(text, "d:\\3.jpg");
        //解析二维码
        System.err.println(decode("d:\\jd.png"));
    }  
}
