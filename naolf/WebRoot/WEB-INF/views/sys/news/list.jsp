                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-sort="false" data-page-size="${vo.pageSize }">
                                ...
                                <tr>
                                    ...
                                    <td><c:choose><c:when test="${n.enabled==0}"><span class="label label-primary">正常</span></c:when><c:otherwise><span class="label label-danger">屏蔽</span></c:otherwise></c:choose></td>
                                    <td>
                                    	...
                                    	<div class="btn-group">
			                                ...
			                                <ul class="dropdown-menu">
			                                    ...
			                                    <li><a onclick="del(1,'${n.id}')" <c:if test="${n.enabled==1}">class="font-bold"</c:if>>屏蔽</a></li>
			                                </ul>
			                            </div>
			                            </shiro:hasPermission>
                                    </td>
