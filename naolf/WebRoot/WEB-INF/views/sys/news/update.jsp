...
<body>
                        ...
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="imageImg" <c:if test="${empty news.image}"> style="display:none"</c:if>  >   
							                 	<img src="${news.image }" style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3" name="descript" style="resize: none">${news.descript }</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <script type="text/plain" id="content">${news.content}
    		   	  					</script>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        $(document).ready(function(){$(".i-checks").iCheck({checkboxClass:"icheckbox_square-green",radioClass:"iradio_square-green"});$("[name='type']").val("${news.type}")});
        ...
        function add(){
        	$.post("${ctx}/manage/news/update",{"id":"${news.id}","type":$("[name='type']").val(),"title":$("[name='title']").val(),"image":$(".imageImg img").attr("src"),"author":$("[name='author']").val(),"descript":$("[name='descript']").val(),"content":ue.getContent()},function(data){
					if(data.code=="0"){
						opt_success("修改成功",0);
					}else{
