...
<body>
                        ...
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio4" value="1" name="must">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <script type="text/plain" id="descript">
    		   	  					</script>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        ...
        function add(){
        	$.post("${ctx}/manage/version/add",{"version":$("[name='version']").val(),"url":$("[name='url']").val(),"descript":ue.getContent(),"type":$("[name='type']:checked").val(),"must":$("[name='must']:checked").val()},function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
