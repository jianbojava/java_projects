...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input   type="text" class="form-control" name="username" value="${user.username }" onchange="checkUsername()">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="mobile" value="${user.mobile }" onchange="checkMobile()">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
		                                <input class="form-control" name="birthday" type="text" placeholder="出生日期" value="<fmt:formatDate value='${ user.birthday}' pattern='yyyy-MM-dd'/>" onchange="changebirth()">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                            ...
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="card" value="${user.card}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="age" value="${user.age }" readonly="readonly">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio2" value="1" name="gender" <c:if test="${user.gender==1}">checked</c:if>>
                            ...
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="bank_no" value="${user.bank_no }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="bank_user" value="${user.bank_user}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="wx_no" value="${user.wx_no}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ali_no" value="${user.ali_no}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <c:if test="${user.user_type==1}">
	                              <div class="form-group">
	                                ...
	                                <div class="col-sm-9">
	                                	<div class="radio radio-success radio-inline">
	                                        <input type="radio" id="inlineRadio3" value="1" name="partner_type"  <c:if test="${user.enabled==1}">disabled="disabled" </c:if> <c:if test="${user.partner_type==1 }">checked</c:if>>
	                                        <label for="inlineRadio3"> 高级 </label>
	                                    </div>
	                                    <div class="radio radio-success radio-inline">
	                                        <input type="radio" id="inlineRadio4" value="2" name="partner_type" <c:if test="${user.enabled==1}">disabled="disabled" </c:if> <c:if test="${user.partner_type==2 }">checked</c:if>>
	                                        <label for="inlineRadio4"> 事业 </label>
	                                    </div>
	                                    <div class="radio radio-success radio-inline">
	                                        <input type="radio" id="inlineRadio5" value="3" name="partner_type" <c:if test="${user.enabled==1}">disabled="disabled" </c:if> <c:if test="${user.partner_type==3 }">checked</c:if>>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
	                                     <select data-placeholder="选择推荐人..." class="chosen-select" tabindex="2"  <c:if test="${(user.user_type==2)||((user.user_type<2)&&(user.enabled==1)&&(isgrade==0)) }">disabled</c:if> name="refer_number" onchange="selectRefer()">
	                       ...
	                       <div id="departdiv">  
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-9">
	                                    <select data-placeholder="选择部门..." class="chosen-select" tabindex="2" name="depart" <c:if test="${(user.user_type==2)||((user.user_type<2)&&(user.enabled==1)&&(isgrade==0)) }"> disabled </c:if>>
	                                    	<option value="" tag="">请选择部门</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<select data-placeholder="选择提成身份等级..."  class="chosen-select" tabindex="2" name="dispacth_grade" <c:if test="${(user.user_type==2)||(user.user_type==1)||((user.user_type==0)&&(user.enabled==1)&&(isgrade==0)) }"> disabled="disabled"</c:if>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                	<input type="checkbox" class="js-switch" name="is_locked" <c:if test="${user.is_locked==1 }">checked</c:if>/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-4" style="text-align: center;">
                                   <c:if test="${is_update==1}">
                                    ...
                                    <c:if test="${is_update==0}">
	                                    <button class="btn btn-primary" type="button" onclick="layer_close()">返回上一步</button>
                                    </c:if>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        $(document).ready(function(){
          $("[name='depart']").val('${user.depart_id}');
          $("[name='dispacth_grade']").val('${user.dispacth_grade}');
           $("[name='refer_number']").val('${user.refer_number}');
       ...
       if(${user.user_type}==2){//如果是会员的话默认是第四等级
           $("[name='dispacth_grade']").val(4);
          $(".chosen-select").trigger("chosen:updated");
        }
        if(${user.user_type}==1){//如果是合伙人的话默认是第1等级
    	...
    	function selectRefer(){
    	    var user_type=${user.user_type};//0员工，1合伙人，2会员
    	...
    	/**
         function validNumber(){
          ...
          var number=$("[name='refer_number']").val();
            verify=0;
          if(number!=null&&number!=""){
             $.post("${ctx}/manage/user/queryByNumber/"+number,function(data){
                 if(data!=null&&data.user!=null){
                   $("#departdiv").css("display","block");
                   if(user_type==2)$("[name='depart']").attr("disabled","disabled");//会员的话禁用
                   $("[name='depart']").val(data.user.depart_id);
                   $(".chosen-select").trigger("chosen:updated");
                 }else{
                    opt_error("推荐人不存在,请重新输入");
                    $("[name='refer_number']").focus();
                    if(user_type==2) $("#departdiv").css("display","none");//会员的话隐藏
                     verify=1;
                 }
             })
          }
          ...
          validMobile=0;
           ...
           if(mobile!=null&&mobile!=""){
        	...
        	$.getJSON("${ctx}/manage/regions/1",function(data){
        		...
        		$("[name='province']").val('${user.province_id}');
        		$(".chosen-select").trigger("chosen:updated");
        ...
        function resetRegion(city_id){
         	$("[name='region']").html("<option value=\"\">请选择区县</option>");
       		...
       		$.getJSON("${ctx}/manage/regions/"+city_id,function(data){
        		...
        		$("[name='region']").val('${user.region_id}');
        		$(".chosen-select").trigger("chosen:updated");
    		})
        }
        ...
        function add(){
           ...
           **/
           ...
           if(user_type==1&&performance_ind==0){
                opt_error("合伙人必须是绩效部门!"); 
                return;
           }
           if((user_type==0)&&(performance_ind==1)){//员工&&有绩效部门
...
// 			alert($("[name='address']").val());return;
            var refer_number='${user.refer_number}';
            if(refer_number==null||refer_number==""){
               var refer_number=$("[name='refer_number']").val();
            }
			var params={ "id":"${user.id}", "username":username,"is_reset":is_reset,
			               "mobile":$("[name='mobile']").val(),"nickname":$("[name='nickname']").val(),
			               ...
			               "wx_no":$("[name='wx_no']").val(),"ali_no":$("[name='ali_no']").val(),"refer_number":refer_number,
			               "partner_type":$("[name='partner_type']:checked").val(),
			               "address":address,
