                        ...
                        <form action="" method="post" class="form-horizontal">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio2" value="1" name="type" <c:if test="${depart.type==1}">checked</c:if>>
                            ...
                            <div class="form-group">
                             ...
                             <div id="lonlatdiv" <c:if test="${depart.type==1}"> style="display:none"</c:if>>
	                            <div class="hr-line-dashed"></div>
	                            <div class="form-group">
	                                <label class="col-sm-2 control-label">经纬度</label>
	
	                                <div class="col-sm-9">
	                                    <input type="text" class="form-control" name="lonlat" placeholder="经纬度" value="${depart.longitude},${depart.latitude}" data-toggle="modal" href="#modal-map" onclick="initMap()">
	                                </div>
	                            </div>
                            </div>
                            <div class="form-group"  >
                                ...
                                <div class="col-sm-9">
                                	<div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio3" value="1" name="performance_ind" <c:if test="${depart.performance_ind==1}">checked</c:if>>
                                        <label for="inlineRadio3"> 是</label>
                                    </div>
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio4" value="0" name="performance_ind" <c:if test="${depart.performance_ind!=1}">checked</c:if>>
      ...
      $('.chosen-select').chosen();
       ...
       $(function(){
	    ...
	    var map;
	 	...
	 	function setMap(){
		    if($("[name='lonlat']").val()==""||$("[name='lonlat']").val()==","){
