...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="representer" value="${firm.representer }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="email" value="${firm.email }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="url" value="${firm.url }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="address" value="${firm.address }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="fileInput" id="licenseUploadify" type="file" name="file" multiple="multiple" accept="image/*"/>
							         <div class="licenseImg" <c:if test="${empty firm.bus_license}"> style="display:none"</c:if>  >   
							                 	<img src="${firm.bus_license }" style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio2" value="1" name="pay_type" <c:if test="${firm.pay_type==1 }">  checked </c:if>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-daterange">
		                                <input class="form-control" name="sign_date" type="text" placeholder="签约时间" value="<fmt:formatDate value='${firm.sign_date }' pattern='yyyy-MM-dd'/>"> 
		                                <span class="input-group-addon">到</span>
		                                <input class="form-control" name="end_date" type="text" placeholder="终止时间" value="<fmt:formatDate value='${firm.end_date }' pattern='yyyy-MM-dd'/>">
		                            </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3" name="remark" style="resize: none">${firm.remark }</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function(){
        	...
        	$("[name='sales']").val('${firm.sale_id}');
    		$(".chosen-select").trigger("chosen:updated");
        });
        function add(){
			var params={"id":"${firm.id}","name":$("[name='name']").val(),"representer":$("[name='representer']").val(),"tel":$("[name='tel']").val(),"email":$("[name='email']").val(),"url":$("[name='url']").val(),"address":$("[name='address']").val(),"bus_license":$(".licenseImg img").attr("src"),"sale_id":$("[name='sales']").val(),"sale_name":$("[name='sales']").find("option:selected").text(),"pay_type":$("[name='pay_type']:checked").val(),
					"sign_date":$("[name='sign_date']").val(),"end_date":$("[name='end_date']").val(),"remark":$("[name='remark']").val()};
			$.post("${ctx}/manage/firm/update",params,function(data){
				if(data.code=="0"){
					opt_success("修改成功",0);
				}else{
