                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="card_number" value="${member.card_number}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="card_no" value="${member.card_no}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="driver_no" value="${member.driver_no}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ship_addr" value="${member.ship_addr }">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                     ...
                                     <div class="card_frontImg" <c:if test="${empty member.card_front}"> style="display:none"</c:if>  >  
						                <img src='${member.card_front}'style="width: 60px;height: 60px">
						             </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="card_backImg" <c:if test="${empty member.card_back}"> style="display:none"</c:if>  >  
						                <img src='${member.card_back}'style="width: 60px;height: 60px">
						           </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="fileInput" id="driverUploadify" type="file" name="file" multiple="multiple" accept="image/*"/>
                                     <div class="driver_scanImg" <c:if test="${empty member.driver_scan}"> style="display:none"</c:if>  >  
							                <img src='${member.driver_scan}'style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="fileInput" id="driverBackUploadify" type="file" name="file" multiple="multiple" accept="image/*"/>
                                     <div class="driver_scan_backImg" <c:if test="${empty member.driver_scan_back}"> style="display:none"</c:if>  >  
							                <img src='${member.driver_scan_back}'style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3" name="remark" style="resize: none">${member.remark }</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
