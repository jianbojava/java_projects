                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-1" class="tab-pane active">
                        	<div class="wrapper wrapper-content">
                        			...
                        			<c:choose>
                        				<c:when test="${order.status>=3 and order.pay_status==1 }">
                        				<div class="row" style="margin-bottom: 20px;">
				                        	<div class="col-sm-12">
				                        		<c:if test="${order.status==3}">
						                        <button type="button" class="btn btn-outline btn-primary" onclick="updateStatus(5)">对账</button>
						                        </c:if>
						                        <!-- 
						                        <c:if test="${order.status==5 }">
						                        <button type="button" class="btn btn-outline btn-danger" onclick="updateStatus(3)">取消对账</button>
				                            	</c:if>
				                            	 -->
				                            </div>
				                        </div>
				                    ...
				                    <div class="well m-t"><textarea class="form-control" name="order_remark" style="resize: none" placeholder="订单备注">${order.order_remark }</textarea><a class="btn btn-white btn-bitbucket" onclick="updateOrder('order_remark',this)"><i class="fa fa-check"></i> 确定</a></div>
			            	</div>
                        </div>
