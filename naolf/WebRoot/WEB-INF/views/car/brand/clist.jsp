                ...
                <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
							...
							<form action="${ctx }/manage/brand/clist" method="post" id="searchForm" class="pull-right mail-search" target='_self'>
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-sort="false" data-page-size="${vo.pageSize }">
                                ...
                                <tr>
                                	<th width="30"><input type="checkbox" class="i-checks" name="input[]" value="${brand.id}"></th>
                                	<td>${brand.name }</td>
                                    ...
                                    <td>
                                    	<shiro:hasPermission name="manage:brand:cupdate">
