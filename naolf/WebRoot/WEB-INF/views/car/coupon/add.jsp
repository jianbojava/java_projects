...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="number" placeholder="编号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" placeholder="网点名称">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="tel" placeholder="服务热线">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                	<div class="input-group input-daterange">
		                                <input class="form-control" name="start_time" type="text" placeholder="开始时间">
		                                <span class="input-group-addon">到</span>
		                                <input class="form-control" name="end_time" type="text" placeholder="结束时间">
		                            </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        ...
        function add(){
			...
			var params={"number":$("[name='number']").val(),"name":$("[name='name']").val(),"address":$("[name='address']").val(),"tel":$("[name='tel']").val(),"start_time":$("[name='start_time']").val(),"end_time":$("[name='end_time']").val(),
        	...
        	$.post("${ctx}/manage/dot/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
						opt_error("添加失败");
