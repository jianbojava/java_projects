...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="equipmentID" placeholder="设备编号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="manufacturerID" placeholder="组织机构代码">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="equipmentModel" placeholder="设备型号">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="productionDate" placeholder="生产日期">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control m-b" name="equipmentType">
                                        <option value="1">直流设备</option>
                                        <option value="2">交流设备</option>
                                        <option value="3">交直流一体设备</option>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        function add(){
        	...
        	$.post("${ctx}/manage/equipmentinfo/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
						opt_error("添加失败");
