...
<body>
    ...
    <script>
        function add(){
			...
			var params={"number":$("[name='number']").val(),"name":$("[name='name']").val(),"address":$("[name='address']").val(),"sign_date":$("[name='sign_date']").val(),"end_date":$("[name='end_date']").val(),
        	...
        	$.post("${ctx}/manage/parking/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
						opt_error("添加失败");
