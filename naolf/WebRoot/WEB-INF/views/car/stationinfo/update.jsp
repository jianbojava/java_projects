...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="stationID" disabled="disabled" placeholder="编号" value="${stationinfo.stationID }">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="stationName" placeholder="名称" value="${stationinfo.stationName }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="address" placeholder="地址" value="${stationinfo.address }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="lonlat" placeholder="经纬度" data-toggle="modal" href="#modal-map" onclick="initMap()" value=<c:if test="${!empty(stationinfo.stationLng) }">${stationinfo.stationLng },${stationinfo.stationLat}</c:if>>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="serviceTel" placeholder="服务电话"  value="${stationinfo.serviceTel }">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="stationTel" placeholder="站点电话"  value="${stationinfo.stationTel }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="siteGuide" placeholder="站点引导"  value="${stationinfo.siteGuide }">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="parkNums" placeholder="车位数量"  value="${stationinfo.parkNums }">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="matchCars" placeholder="使用车型描述"  value="${stationinfo.matchCars }">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="parkInfo" placeholder="车位楼层及数量描述"  value="${stationinfo.parkInfo }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="elePrice" placeholder="充电费（元/度）"  value="${stationinfo.elePrice }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="serPrice" placeholder="服务费（元/度）"  value="${stationinfo.serPrice }">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="electricityFee" placeholder="充电费描述"  value="${stationinfo.electricityFee }">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="serviceFee" placeholder="服务费率描述"  value="${stationinfo.serviceFee }">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="parkFee" placeholder="停车费率描述"  value="${stationinfo.parkFee }">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="busineHours" placeholder="营业时间描述" value="${stationinfo.busineHours }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="gallerysImg" <c:if test="${empty stationinfo.pictures}"> style="display:none"</c:if>  >   
							                 	<img src="${stationinfo.pictures }" style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="5" name="remark" style="resize: none" placeholder="备注信息">${stationinfo.remark }</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    $(document).ready(function(){
    	$("[name='stationType']").val('${stationinfo.stationType}');
    	$("[name='stationStatus']").val('${stationinfo.stationStatus}');
    	$("[name='construction']").val('${stationinfo.construction}');
    	$("[name='supportOrder']").val('${stationinfo.supportOrder}');
    	$("[name='operatorID']").val('${stationinfo.operatorID}');
    	$("[name='payment']").val('${stationinfo.payment}');
		$(".chosen-select").trigger("chosen:updated");
    });
        function add(){
			var lonlat=$("[name='lonlat']").val();
			var params={"stationID":"${stationinfo.stationID}","operatorID":$("[name='operatorID']").val(),"stationName":$("[name='stationName']").val(),"address":$("[name='address']").val(),"serviceTel":$("[name='serviceTel']").val(),"stationTel":$("[name='stationTel']").val(),
        	...
        	$.post("${ctx}/manage/stationinfo/update",params,function(data){
					if(data.code=="0"){
						opt_success("修改成功",0);
					}else{
						opt_error("修改失败");
	    ...
	    var map;
	 	...
	 	function setMap(){
		    if($("[name='lonlat']").val()==""){
				...
				myGeo.getPoint(addr!=''?addr:'上海市外高桥', function(point) {
					if (point) {
