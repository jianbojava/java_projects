...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="operatorID" placeholder="运营商编号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="operatorName" placeholder="运营商名称">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="operatorTel1" placeholder="电话1">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="operatorTel2" placeholder="电话2">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="operatorRegAddress" placeholder="注册地址">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="5" name="operatorNote" style="resize: none" placeholder="备注信息"></textarea>
                                </div>
                            </div>
    ...
    <script>
        function add(){
			var params={"operatorID":$("[name='operatorID']").val(),"operatorName":$("[name='operatorName']").val(),"operatorTel1":$("[name='operatorTel1']").val(),"operatorTel2":$("[name='operatorTel2']").val(),
			"operatorRegAddress":$("[name='operatorRegAddress']").val(),"operatorNote":$("[name='operatorNote']").val()};
        	$.post("${ctx}/manage/operatorinfo/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
						opt_error("添加失败");
