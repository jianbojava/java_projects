	...
	<div class="main" style="height: 30%">
		<div class="payway_topcontent" style="border-bottom: none;margin-top: 40px">
			<div class="payway_topline">
				<span class="payway_span1">编号：</span><span class="payway_span2">${ut_sn}</span>
			</div>
			<div class="payway_topline">
...
<div id="main" style="display: none">
        <form name=alipayment action="${ctx}/pay/alipay/wxupgradealipayapi" method=post >
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dt>订单描述：</dt>
					<dd>
						<input name="WIDbody" id="WIDbody" value="${ut_sn}" />
					</dd>
                    			<hr class="one_line">
					<dt>超时时间：</dt>
					<dd>
