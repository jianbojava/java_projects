	...
	<div class="main" style="height: 30%">
		<div class="payway_topcontent" style="border-bottom: none;margin-top: 40px">
			<div class="payway_topline">
				<span class="payway_span1">编号：</span><span class="payway_span2">${sn}</span>
			</div>
			<div class="payway_topline">
				<span class="payway_span1">支付总额：</span><span class="payway_span2">￥<fmt:formatNumber value="${total}" pattern="0.00" /></span>
			</div>
		</div>
...
<script type="text/javascript">
 ...
 function callpay(){
  		var options = {
			url : "${ctx}/pay/wxpay/true_payscore",
			type : "post",
			dataType: "json",
				...
				if(data.code=="0"){
					WeixinJSBridge.invoke('getBrandWCPayRequest',{
						...
						if(res.err_msg == "get_brand_wcpay_request:ok"){ 
			             	$("#loading").html("");
							alertN("微信支付成功!");
			            	 setTimeout("javascript:location.href='${ctx}/wap/my/my'",1500);
