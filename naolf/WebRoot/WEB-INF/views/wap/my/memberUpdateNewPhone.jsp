...
<div class="container">
	<div class="forgetPwd mBtm96">
    	<div class="row">
        	<label>手机号：</label>
        	<input type="text" placeholder="请输入新手机号码" id="mobile" class="row_input" />
...
$(".row_btn").click(function(){          
   $.post("${ctx}/wapapi/sms/memberNotCode",{"mobile":$("#mobile").val()},function(data){
      if(data.code=="0"){ 
    	  time();
...
$(".submitBtn").click(function(){
   $.post("${ctx}/myapi/memberUpdateNewPhone",{"mobile":$("#mobile").val(),"code":$("#code").val()},function(data){
      if(data.code=="0"){ 
