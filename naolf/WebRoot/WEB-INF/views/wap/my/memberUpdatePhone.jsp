...
<div class="container">
	<div class="forgetPwd mBtm96">
    	<div class="row">
        	<label>手机号：</label>
        	<input type="text" placeholder="请输入旧手机号码" id="mobile" class="row_input" />
...
var mobile=$("#mobile").val();         
   ...
   $.post("${ctx}/wapapi/sms/memberCode",{"mobile":$("#mobile").val()},function(data){
      if(data.code=="0"){ 
    	  time();
...
$(".submitBtn").click(function(){
   $.post("${ctx}/myapi/memberUpdatePhone",{"mobile":$("#mobile").val(),"code":$("#code").val()},function(data){
      if(data.code=="0"){ 
		avascript:location.href="${ctx}/wap/my/memberUpdateNewPhone";
      }else{
      	alertN(data.msg);
      }
   },"json");
