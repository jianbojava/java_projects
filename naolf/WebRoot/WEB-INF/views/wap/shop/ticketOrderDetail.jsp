        ...
        <div class="orderDetail">
	        ...
	        <c:forEach items="${list}" var="l">
            	...
            	<div class="orderPic fl">
                	<img src="${l.image}" alt="" class="orderImg" />
                </div>
            	<div class="orderDe fl">
                	<div class="title bold f28">${l.name }:${l.catname }</div>
                	<div class="age f24 color_a5a4a8">适用年龄：${l.userage }周岁</div>
                    <c:if test="${l.type==1}"><div class="course f24 color_a5a4a8">训练课时：${l.period }天集中训练</div></c:if>
                    <c:if test="${l.type==0}"><div class="course f24 color_a5a4a8">训练课时：${l.period }天集中训练+${l.train }课时进阶训练</div></c:if>
                	<div class="price color_745398">
                    	<span class="f24">&yen;</span>
                        <span class="f30 bold">${l.price }</span>
                    </div>
                </div>
                </div>
            </c:forEach>
