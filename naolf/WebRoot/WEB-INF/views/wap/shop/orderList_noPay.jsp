...
<div class="container mBtm95">
	<div class="order_list_con confirm_order">
    	<ul class="tabs clearfix">
        	<li><a href="${ctx}/wap/shop/orderList">全部订单</a></li>
        	<li><a href="${ctx}/wap/shop/orderList_pay">已经付款</a></li>
        	<li  class="active"><a href="${ctx}/wap/shop/orderList_noPay">等待付款</a></li>
        </ul>
            ...
            <div class="orderDetail">
                ...
                <div class="orderListBlock clearfix">
                    ...
                    <div class="btnGroup fr">
                        ...
                        <c:if test="${l.status==1 }"><input type="button" value="去上课" class="btn btn_purple" readonly/></c:if>
                    </div>
                </div>
            </div>
            </c:forEach>
            ...
            <div class="orderDetail">
                ...
                <div class="orderListBlock clearfix">
                    ...
                    <div class="btnGroup fr">
                        ...
                        <c:if test="${t.status==1 }"><input type="button" value="去上课" class="btn btn_purple" readonly/></c:if>
                    </div>
                </div>
            </div>
            </c:forEach>
