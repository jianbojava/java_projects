...
<div class="container mBtm95">
	<div class="order_list_con confirm_order">
    	<ul class="tabs clearfix">
        	...
        	<li class="active"><a href="${ctx}/wap/shop/orderList_pay">已经付款</a></li>
            ...
            <div class="orderDetail">
                <div class="orderName f28">
                    <div class="clearfix">
                        ...
                        <c:if test="${t.status==0 }"><div class="color_a5a4a8 fr">等待买家付款1</div></c:if>
...
<script type="text/javascript">
		...
		function paymentT(id){
		    javascript:location.href="${ctx}/wap/shop/ticketListOrder?tid="+id;
		}
