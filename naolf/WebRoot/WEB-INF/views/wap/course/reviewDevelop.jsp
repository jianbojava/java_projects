...
function appointAdd(id){
        	$.post("${ctx}/courseApi/addappoint",{"user_ticket_id":$("#ut_id").val(),"course_id":id},function(data){
					if(data.code=="0"){
...
function cancelappoint(id){
      	$.post("${ctx}/courseApi/cancelappoint",{"user_ticket_id":$("#ut_id").val(),"course_id":id},function(data){
			if(data.code=="0"){
			layui.use(['layer', 'form'], function(){
			  var layer = layui.layer
			  ,form = layui.form();	
