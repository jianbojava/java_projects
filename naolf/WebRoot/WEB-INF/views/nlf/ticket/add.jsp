                        ...
                        <form action="" method="post" class="form-horizontal">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="use_rule" >
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
	                            ...
	                            <div class="form-group">
		                               ...
		                               <div class="col-sm-9">
		                               	<c:forEach items="${lessons }" var="lesson">
		                               		<label class="checkbox-inline i-checks"><input type="checkbox" value="${lesson.id }" name="lesson">${lesson.name }</label>
		                               	</c:forEach>
		                               </div>
		                           </div>
	                           </div>
	                           <div id="liddiv" style="display: none">
	                                ...
	                                <div class="col-sm-9">
	                                   <c:forEach items="${lessons}" var="l" varStatus="index">
	                                	<div class="radio radio-success radio-inline">
	                                        <input type="radio" id="${l.id }" value="${l.id}" name="mylesson">
    ...
    <script>
        ...
        function add(){
           var lesson_ids;
        	...
        	$.post("${ctx}/manage/ticket/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else if(data.code=="2"){
