...
<body>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select data-placeholder="课程选择..." class="chosen-select" tabindex="2" name="lesson_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-daterange">
		                                	<input class="form-control input-sm" type="text" name="star_time" placeholder="发布日期" style="width:300px">
		                            </div>
                                </div>
                            </div>
                            <div id="enddiv" style="display: none">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-9">
	                                    <div class="input-group input-daterange">
		                               			<input class="form-control input-sm" type="text" name="end_time" placeholder="结束日期" style="width:300px">
			                            </div>
	                                </div>
	                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly name="" value="${depart.name}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">部门地址</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly name="" value="${depart.province_name}${depart.city_name}${depart.region_name}${depart.address}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div> -->
	...
	$("[name='end_time']").datetimepicker().on("changeDate", function(ev){
        ...
        function add(){
        	...
        	$.post("${ctx}/manage/course/add",params,function(data){
					if(data.code=="0"){
						opt_success("添加成功",0);
					}else{
						opt_error("添加失败");
