                           ...
                           <div class="form-group" id="typeDiv" >
                            <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="inlineRadio2" value="1" name="type"  <c:if test="${lesson.type==1}">checked</c:if>>
                                        <label for="inlineRadio2"> 集中训练</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="typeDivs" <c:if test="${lesson.type==1}">style="display:none"</c:if>>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" placeholder="课程特点" name="special" >${lesson.special}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="fileInput" id="imageUploadify" type="file" name="file" multiple="multiple" accept="image/*"/>
                                     <div class="FildImg" <c:if test="${empty lesson.image}"> style="display:none"</c:if>>   
							                 	<img src="${ lesson.image}" style="width: 60px;height: 60px">
							         </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                <label class="col-sm-2 control-label">课程特色</label>
                                <div class="col-sm-9">
                                    <script type="text/plain" id="content">${lesson.content}
    		   	  					</script>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
     var ue=UE.getEditor('content',{
        ...
        function update(){
        	...
        	$.post("${ctx}/manage/lesson/update",params,function(data){
					if(data.code=="0"){
						opt_success("修改成功",0);
					}else{
						opt_error("修改失败");
