                        ...
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="sort" value="${rule.sort}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">编码</label>
                                   <div class="col-sm-2">
                                	<input type="text" class="form-control" readonly="readonly" name="sn_header" value="No">
                                	 ...
                                	 <div class="col-sm-2">
                                	<input type="text" class="form-control" name="sn_start" value="${rule.sn_start}">
                                	</div>
                                	 <div class="col-sm-2">
                                	<input type="text" class="form-control" readonly="readonly" name="sn_middle" value="00000">
                                	 </div>
                                	  <div class="col-sm-2">
                                	<input type="text" class="form-control" name="sn_end" placeholder="尾码" value="${rule.sn_end}"></div>
                             ...
                             <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-9">
                                	<input type="checkbox" class="js-switch" name="available" <c:if test="${rule.enabled==0}">checked</c:if> />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
         function update(){
           ...
           var available=1;
			...
			var params={"id":'${rule.id}',"name":$("[name='name']").val(),"sort":$("[name='sort']").val(),"sn_start":$("[name='sn_start']").val(),"sn_end":$("[name='sn_end']").val(),"enabled":available};
        	$.post("${ctx}/manage/rule/update",params,function(data){
					if(data.code=="0"){
						opt_success("修改成功",0);
					}else if(data.code=="2"){
					   opt_error("编号已存在");
